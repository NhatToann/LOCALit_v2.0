        ...
        <div className="auth-branding">
          <div className="branding-content">
            ...
            <div className="branding-text">
              <h1>Welcome Back</h1>
              <p>Continue your journey and connect with amazing local buddies in Da Nang.</p>
            </div>

            <div className="branding-features">
              <div className="feature-item">
                <div className="feature-icon">✓</div>
                <span>Smart buddy recommendations tailored to your interests</span>
              </div>
              <div className="feature-item">
                <div className="feature-icon">✓</div>
                <span>Real-time location of buddies near you</span>
              </div>
              <div className="feature-item">
                <div className="feature-icon">✓</div>
                <span>Plan and collaborate on itineraries together</span>
              </div>
            </div>
          ...
          <div className="auth-form-container">
            ...
            {registered && (
              <div className="login-info">
                ...
                <p style={{ color: '#166534', fontWeight: 600 }}>Sign up successful!</p>
            ...
            <div className="social-buttons">
              <button
                ...
                onClick={() => alert('Google sign-in is a demo placeholder. Please use email.')}
              >
              ...
              <button
                type="button"
                className="social-btn"
                onClick={() => alert('GitHub sign-in is a demo placeholder. Please use email.')}
              >
